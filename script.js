...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Failsafe: pastikan overlay loading SELALU hilang walau ada error rendering
  // (misal CDN Chart.js gagal dimuat karena internet lambat/offline)
  ...
  const failsafeOverlayTimer = setTimeout(sembunyikanOverlay, 4000);
  ...
  try {
    ...
    console.error('Gagal render awal (app tetap dilanjutkan):', err);
  }

  // Sembunyikan loading
  clearTimeout(failsafeOverlayTimer);
  setTimeout(sembunyikanOverlay, 1200);
